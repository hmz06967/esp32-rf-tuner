 ...
 * @create date 2022-08-19 05:15:19
 * @modify date 2022-08-19 05:15:19
 * @desc 
 */
#ifndef TUNER_H_
#define TUNER_H_
...
#define I2C_ADDR_TUNER 0xC2>>1 //C2 write, C2+1 read

//vhf 50 - 400 Mhz, Uhf 300 - 900 Mhz
//BS3 port 1; 
#define BAND_UHF 0x3//361.25 - 801.25 Mhz 
#define BAND_LOW_UHF 0x01 //port off
#define BAND_MEDIUM_UHF 0xB//vhf low + uhf
#define BAND_HIGH_UHF 0x07 //vhf high + uhf
#define BAND_ULTRAHIGH_UHF 0x0F //all freq

#define BAND_VHF 0x0A//vhf 50 - 400 mhz
#define BAND_LOW_VHF 0x0C //55.25 - 127.25 Mhz
#define BAND_HIGH_VHF 0x0E//133.25 - 361.25 Mhz
